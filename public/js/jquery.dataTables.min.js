...
(function (h) {
    ...
    function Ka(a, b, c, d) {
        var e = [],
            ...
            G = function (a) {
                if (c === k || c === i)
                    (j = m[i]), (l = h.trim(a.innerHTML)), j && j._bAttrSrc ? (N(j.mData._)(d, l), u(j.mData.sort, a), u(j.mData.type, a), u(j.mData.filter, a)) : q ? (j._setter || (j._setter = N(j.mData)), j._setter(d, l)) : (d[i] = l);
                i++;
            };
        if (f)
            for (; f; ) {
        ...
        if (-1 !== h.inArray(!1, b)) D(a, !1);
            ...
            if (0 !== i.length) {
                ...
                (c = f.sZeroRecords),
                    ...
                    (b[0] = h("<tr/>", { class: e ? d[0] : "" }).append(h("<td />", { valign: "top", colSpan: W(a), class: a.oClasses.sRowEmpty }).html(c))[0]);
        ...
        for (i = c.length; f < i; f++) {
            ...
            for (e = d.firstChild; e; ) {
                if ("TD" == e.nodeName.toUpperCase() || "TH" == e.nodeName.toUpperCase()) {
                    ...
                    l = g;
                    k = 1 === m ? !0 : !1;
                    for (j = 0; j < m; j++) for (g = 0; g < q; g++) (a[f + g][l + j] = { cell: e, unique: k }), (a[f + g].nTr = d);
                }
                e = e.nextSibling;
            }
        }
    ...
    function wb(a) {
        ...
        for (g = 0; g < c; g++)
            (l = b[g]),
                ...
                G.columns.push({ data: i, name: l.sName, searchable: l.bSearchable, orderable: l.bSortable, search: { value: m.sSearch, regex: m.bRegex } }),
                u("mDataProp_" + g, i),
                d.bFilter && (u("sSearch_" + g, m.sSearch), u("bRegex_" + g, m.bRegex), u("bSearchable_" + g, l.bSearchable)),
        ...
        for (f = a.aoData.length; d < f; d++)
            if (((h = a.aoData[d]), !h._aFilterData)) {
                ...
                for (g = b.length; e < g; e++)
                    (c = b[e]),
                        c.bSearchable ? ((i = B(a, d, e, "filter")), m[c.sType] && (i = m[c.sType](i)), null === i && (i = ""), "string" !== typeof i && i.toString && (i = i.toString())) : (i = ""),
                        i.indexOf && -1 !== i.indexOf("&") && ((wa.innerHTML = i), (i = Yb ? wa.textContent : wa.innerText)),
        ...
        i = h("<div/>", { class: f.sScrollWrapper })
            .append(
                h("<div/>", { class: f.sScrollHead })
                    .css({ overflow: "hidden", position: "relative", border: 0, width: d ? (!d ? null : w(d)) : "100%" })
                    .append(
    ...
    function Ha(a) {
        ...
        if (d || (!u && !f && !e && j == W(a) && j == l.length)) for (n = 0; n < j; n++) (i = ba(a, n)), null !== i && (c[i].sWidth = w(l.eq(n).width()));
        else {
            ...
            for (n = 0; n < i.length; n++)
                (o = c[i[n]]),
                    (l[n].style.width = null !== o.sWidthOrig && "" !== o.sWidthOrig ? w(o.sWidthOrig) : ""),
                    o.sWidthOrig && f && h(l[n]).append(h("<div/>").css({ width: o.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
    ...
    function Y(a) {
        ...
        for (a = 0; a < l.length; a++) {
            ...
            for (c = f.length; b < c; b++)
                (g = f[b]), (j = e[g].sType || "string"), l[a]._idx === k && (l[a]._idx = h.inArray(l[a][1], e[g].asSorting)), d.push({ src: i, col: g, dir: l[a][1], index: l[a]._idx, type: j, formatter: n.ext.type.order[j + "-pre"] });
        }
        return d;
    }
    function ob(a) {
    ...
    function Wa(a, b, c, d) {
        ...
        c && a.oFeatures.bSortMulti
            ? ((c = h.inArray(b, C(e, "0"))), -1 !== c ? ((b = g(e[c], !0)), null === b && 1 === e.length && (b = 0), null === b ? e.splice(c, 1) : ((e[c][1] = f[b]), (e[c]._idx = b))) : (e.push([b, f[0], 0]), (e[e.length - 1]._idx = 0)))
            : e.length && e[0][0] == b
                ...
                if (d._details) {
                    ...
                    0 < C(g, "_details").length &&
                        ...
                        f.on("column-visibility.dt.DT_details", function (a, b) {
                            if (e === b) for (var c, d = W(b), f = 0, h = g.length; f < h; f++) (c = g[f]), c._details && c._details.children("td[colspan]").attr("colspan", d);
                        }),
                    ...
                    o = function (b, d) {
                        ...
                        for (s = d.length; k < s; k++) {
                            ...
                            if (h.isArray(t)) {
                                ...
                                if (l !== null) {
                                    r = h("<a>", { class: g.sPageButton + " " + m, "aria-controls": a.sTableId, "aria-label": i[t], "data-dt-idx": n, tabindex: r, id: c === 0 && typeof t === "string" ? a.sTableId + "_" + t : null })
                                        .html(l)
                                        .appendTo(b);
                                    Xa(r, { action: t }, w);
                                    n++;
