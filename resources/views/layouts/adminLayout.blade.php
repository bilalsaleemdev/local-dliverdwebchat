        ...
        <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
          <div class="input-group">
            <div class="input-group-append m-auto">
              <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-search" fill="#8EE868" xmlns="http://www.w3.org/2000/svg">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown no-arrow mr-3">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chevron-down small" fill="#8EE868" xmlns="http://www.w3.org/2000/svg">
          ...
          <li class="nav-item dropdown no-arrow mr-4 ml-2">
            <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-bell" fill="#8EE868" xmlns="http://www.w3.org/2000/svg">
