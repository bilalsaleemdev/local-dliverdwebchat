...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <div class="navbar-nav sidebarbdrad bg-admin-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar"
         style="background-image:url({{ asset('image/sidebarbg.png') }})">

      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#!">
        <div class="sidebar-brand-icon text-lowercase">
          <!--class for rotate rotate-n-15 -->
          dlivrd
          <!-- <img src="" alt=""> -->
        </div>
      </a>
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <div class="input-group-append m-auto">
                  <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-search" fill="#00C3C3" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M10.442 10.442a1 1 0 0 1 1.415 0l3.85 3.85a1 1 0 0 1-1.414 1.415l-3.85-3.85a1 1 0 0 1 0-1.415z"/>
                    <path fill-rule="evenodd" d="M6.5 12a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11zM13 6.5a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0z"/>
                  </svg>
              </div>
              <input type="text" class="form-control border-0 ml-2 small" placeholder="Search" aria-label="Search" aria-describedby="basic-addon2">
            </div>
          </form>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mr-3">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chevron-down small" fill="#00C3C3" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="nav-item dropdown no-arrow mr-4 ml-2">
              <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-bell" fill="#00C3C3" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="nav-item mr-3 ml-2">
              <a href="#" class="btn btn-lg bg-admin-primary rounded-circle pdlr" data-toggle="modal" data-target="#create">+</a>
            </li>     
          </ul>
        </nav>
        <!-- End of Topbar -->
